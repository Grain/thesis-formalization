...
Section bisim.
  ...
  Lemma bisim_lte' {R1 R2} p p' Q Q' (t : itree (sceE config) R1) (s : itree (sceE specConfig) R2) c1 c2 :
    p <= p' ->
  ...
  Proof.
    ...
    - constructor; eauto. Fail apply Hp'. eapply Perms_downwards_closed; eauto. apply Hlte. auto.
